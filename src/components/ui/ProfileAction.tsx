...
function ProfileAction({
    ...
    return (
        <div
            className={`${show ? 'flex flex-col' : 'hidden'} absolute right-0 bottom-0 w-fit translate-y-full flex-col gap-2 rounded-sm bg-(--background-header) py-4! text-sm font-bold text-balance inset-shadow-sm inset-shadow-white/10`}
        >
