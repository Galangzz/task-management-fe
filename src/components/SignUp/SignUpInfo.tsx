...
function SignUpInfo({ active, setActive }: SignUpInfoProps) {
    return (
        <div
            className={`transition-all! absolute right-0 z-2 flex h-full w-1/2 translate-x-1/1 max-md:translate-y-full flex-col justify-center p-4! text-center opacity-0 delay-300! duration-700! ease-in-out! max-md:bottom-0 max-md:h-1/4 max-md:w-full max-md:flex-row ${active === 'REGISTER' && 'opacity-100 max-md:translate-y-0! translate-x-0!'}`}
        >
